#ifndef PROXY_LOAD_BALANCE_HPP
#define PROXY_LOAD_BALANCE_HPP
...
namespace proxy {
    ...
    class load_balance {
    public:
        std::vector<proxy::upstream_server *> *upstream_server_list;
    ...
    public:
        load_balance() {
            index = 0;
            this->upstream_server_list = new std::vector<proxy::upstream_server *>();
        }
        ...
        virtual proxy::upstream_server *choseServer();
    };
}
#endif